...
public class MutilTouchActivity extends Activity implements View.OnTouchListener, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mutil_touch);
        //放大按钮
        ...
        bmp = BitmapFactory.decodeResource(MutilTouchActivity.this.getResources(), R.mipmap.girl);
