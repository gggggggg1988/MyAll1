...
//        throw new UnsupportedOperationException("Not yet implemented");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        bindService(new Intent(this, LocalService.class),connection,BIND_IMPORTANT);
...
//        NotificationManager manager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
    ...
    class ServiceConnection implements android.content.ServiceConnection {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            RemoteService.this.bindService(new Intent(RemoteService.this, LocalService.class),connection,BIND_IMPORTANT);
        }
    }
}
