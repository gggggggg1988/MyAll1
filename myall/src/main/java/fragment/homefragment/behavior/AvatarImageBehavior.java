package fragment.homefragment.behavior;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, CircleImageView child, View dependency) {
        Log.i(TAG, "layoutDependsOn: ------dependency:"+dependency.toString());//此处dependency会不断轮训传递过来所有coordinatorLayout的childview
        return dependency instanceof Toolbar;//这里写谁下面的onDependentViewChanged里面的dependency就会固定是谁
    }
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        Log.i(TAG, "maybeInitProperties: -----"+dependency.toString());
