...
public class StickyRecyclerView extends RecyclerView {
    ...
    public StickyRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        // 分割线的高度
        lineHeight = array.getDimensionPixelOffset(R.styleable.StickyRecyclerView_StickyRecyclerView_dividerHeight,1);
        // 分栏的高度
        titleHeight = array.getDimensionPixelOffset(R.styleable.StickyRecyclerView_StickyRecyclerView_titleHeight,dip2px(context,35));
        // 分割线颜色
        lineColor = array.getColor(R.styleable.StickyRecyclerView_StickyRecyclerView_dividerColor, Color.LTGRAY);
        // 分栏背景色
        titleColor = array.getColor(R.styleable.StickyRecyclerView_StickyRecyclerView_titleColor,Color.LTGRAY);
        // 分栏文字颜色
        titleTextColor = array.getColor(R.styleable.StickyRecyclerView_StickyRecyclerView_titleTextColor,Color.BLUE);
        array.recycle();
        // 不用说,肯定是线性布局了,默认就实现
