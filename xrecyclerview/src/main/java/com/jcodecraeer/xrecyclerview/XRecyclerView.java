...
import ndkjnidemo.wobiancao.com.recyclerview_swipe.touch.DefaultItemTouchHelper;
import ndkjnidemo.wobiancao.com.recyclerview_swipe.touch.OnItemMoveListener;
import ndkjnidemo.wobiancao.com.recyclerview_swipe.touch.OnItemMovementListener;
import ndkjnidemo.wobiancao.com.recyclerview_swipe.touch.OnItemStateChangedListener;
...
public class XRecyclerView extends RecyclerView {
    ...
    public void setAdapter(Adapter adapter) {
        SwipeMenuAdapter menuAdapter = null;
        if (adapter instanceof SwipeMenuAdapter) {//swipe处理
        ...
        mWrapAdapter = new WrapAdapter(menuAdapter);//headerview处理
    ...
    private class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == TYPE_REFRESH_HEADER) {
                return new SimpleViewHolder(mRefreshHeader);//addRefreshHeader 添加刷新头部view
